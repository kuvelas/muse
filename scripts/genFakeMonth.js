...
var fakeMonth = (function () {
	...
	generator.generateFakeMonth = function(){
		...
		var setThrusday = function (){
			...
			add(["4 19:15",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 19:30",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 19:45",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 20:00",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 20:15",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 20:30",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 20:45",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
			startDate.setTime(endDate.getTime());
			endDate.setTime(startDate.getTime() + timeDelta);
			add(["4 21:00",new Date(startDate.getTime()), new Date(endDate.getTime()), "00000", "00000",true, "linksys", link0, signal0, data1, data1, false, "T-Mobile", null, signal0, data0, data0, false, true]);
